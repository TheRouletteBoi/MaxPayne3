...
{ \
	g_Invoker->Push(va_arg(_nativeVarArgsList, Any)); \
}
...
namespace DEBUG
{
   ...
   static void SCRIPT_ASSERT(const char* format, int argCount, ...)
   {
      ...
      g_Invoker->Push(format);
      g_Invoker->Push(argCount);
      NATIVE_VARARGS_PUSH();
      NATIVE_VARARGS_END();

      g_Invoker->EndCall(0xD9BCCE95);
   }
...
namespace HUD
{
   ...
   {
      NATIVE_VARARGS_BEGIN(argCount);
      g_Invoker->Push(index);
      g_Invoker->Push(argCount);
      NATIVE_VARARGS_PUSH();
      NATIVE_VARARGS_END();

      g_Invoker->EndCall(0xA2A179B2);
      return g_Invoker->GetReturn<BOOL>();
   }
   ...
   static int UI_GET_SELECTED_INDEX(int argCount, ...)
   {
      ...
      g_Invoker->EndCall(0x8B63A008);
      return g_Invoker->GetReturn<int>();
   }
   ...
   static Hash GET_FRONTEND_STATE_NAME(int bufferSize, const char* buffer) { return invoke<Hash>(0x4695E609, bufferSize, buffer); } // unused
   ...
   static void GET_LOADOUT_SLOT_NAME(int bufferSize, const char* buffer, int slot) { invoke<Void>(0x917F5D80, bufferSize, buffer, slot); }
   ...
   static void _0xDDEFBB33(int loadoutSlot, const char* buffer) { invoke<Void>(0xDDEFBB33, loadoutSlot, buffer); } // unused
   static Hash _0x5F5212D9(Hash weaponHash, const char* buffer) { return invoke<Hash>(0x5F5212D9, weaponHash, buffer); } // unused
}
...
namespace MISC
{
   ...
   static Vector3 GET_GAMEPLAY_HELPER_VOLUME_COORD(const char* name) { return invoke<Vector3>(0x2A9EA7D3, name); } // unused
   ...
   {
      NATIVE_VARARGS_BEGIN(argCount);
      g_Invoker->Push(bufferSize);
      g_Invoker->Push(buffer);
      g_Invoker->Push(formatOrTextLabel);
      g_Invoker->Push(argCount);
      NATIVE_VARARGS_PUSH();
      NATIVE_VARARGS_END();

      g_Invoker->EndCall(0x1EBBD64A);
   }
   static void STRING_FORMAT_HASH(int bufferSize, const char* buffer, Hash textLabelHash, int argCount, ...)
   {
      ...
      g_Invoker->Push(bufferSize);
      g_Invoker->Push(buffer);
      g_Invoker->Push(textLabelHash);
      g_Invoker->Push(argCount);
      NATIVE_VARARGS_PUSH();
      NATIVE_VARARGS_END();

      g_Invoker->EndCall(0xA1091C07);
   }
...
namespace VEHICLE
{
   ...
   static void GET_STATION_NAME(int bufferSize, const char* buffer, Vehicle train, int p3) { invoke<Void>(0x62D15DE6, bufferSize, buffer, train, p3); } // unused
...
namespace DEATHRECORD
{
   ...
   static void DEATHRECORD_GET_SUB_KILLER_NAME(int bufferSize, const char* buffer, int p2) { invoke<Void>(0xE57A1FF2, bufferSize, buffer, p2); } // unused
   ...
   static void DEATHRECORDS_GET_PLAYERDETAILS_NAME(int bufferSize, const char* buffer, int index) { invoke<Void>(0x9F80529A, bufferSize, buffer, index); } // unused
